RendererTemplates.geojson_points("power_plants", {
  ...
  url: CDN(GEOSERVER + "/ny/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=ny:power_plants&maxFeatures=500&outputFormat=application%2Fjson"),

  pointToLayer: function (active_layer, feature, latlng) {
    var icon_url;
    icon_url = './img/icons/PowerPlant_' + feature.properties.primsource + '.png'
